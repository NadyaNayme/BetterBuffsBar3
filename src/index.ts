...
let helperItems = {
	...
	TrackedBuffs: <HTMLUListElement>getByID('BuffsInstall3'),
	TrackedBuffs2: <HTMLUListElement>getByID('Buffs2Install3'),
	TrackedBuffs3: <HTMLUListElement>getByID('Buffs3Install3'),
	UntrackedBuffs: <HTMLUListElement>getByID('UntrackedBuffsInstall3'),
...
function deleteLocalStorage() {
	...
	localStorage.removeItem('BuffsInstall3');
	localStorage.removeItem('Buffs2Install3');
	localStorage.removeItem('Buffs3Install3');
	localStorage.removeItem('UntrackedBuffsInstall3');
	location.reload();
}
